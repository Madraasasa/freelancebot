...
def start(message, fuc, kurs):
    ...
    if message.from_user.id in a:
        cur.execute(
            'update  users set name = ' + str(message.from_user.id) + ', fuck = ' + "'" + fuc + "'" + ', kurs = ' + str(
                kurs) + ', username = ' + "'" + str(message.from_user.username) + "'" + ' where name = ' + str(
        ...
        try:
            cur.execute('INSERT INTO users VALUES (' + str(message.from_user.id) + ',' + "'" + fuc + "'" + ',' + str(
                kurs) + ',' + "'" + str(message.from_user.username) + "'" + ');')
            con.commit()
